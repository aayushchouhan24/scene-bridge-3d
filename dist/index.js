...
class DomObject {
    ...
    ray = new THREE__namespace.Ray(new THREE__namespace.Vector3(), new THREE__namespace.Vector3());
    ...
    constructor(node, element, camera) {
        ...
        this.center.copy(wb.getCenter(new THREE__namespace.Vector3()));
        this.size.copy(computeBox(node).getSize(new THREE__namespace.Vector3()));
    ...
    resize() {
        ...
        const f = THREE__namespace.MathUtils.degToRad(this.camera.fov) / 2;
